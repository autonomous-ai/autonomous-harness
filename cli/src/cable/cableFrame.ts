...
//
// The mirror image of device/harness/main/cable_frame.c. Both halves are checked against ONE shared
// vector file (vectors/cable_frame.txt here, generated by device/harness/scripts/gen_cable_vectors.py from
