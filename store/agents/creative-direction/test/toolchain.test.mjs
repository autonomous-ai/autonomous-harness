...
test('the template placeholder embeds a seeded PRNG and moodboard anatomy', () => {
  const html = readFileSync(join(here, 'template/board/index.html'), 'utf8')
  assert.match(html, /mulberry32/)
  assert.match(html, /swatches|Moodboard/)
})
